        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="fade-up">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="relative flex h-8 w-8 items-center justify-center rounded-full text-sm font-extrabold text-white shadow-md shadow-pink-300/40" style={{background:"linear-gradient(135deg,#9333EA,#C084FC)"}}>
