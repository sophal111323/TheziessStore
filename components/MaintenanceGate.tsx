...
export default function MaintenanceGate() {
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] flex min-h-screen items-center justify-center overflow-hidden bg-[#0f0318]/75 px-4 py-8 font-khmer backdrop-blur-xl"
      role="alertdialog"
      aria-modal="true"
      aria-labelledby="maintenance-title"
    >
      <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-purple-400/25 blur-3xl" />
      <div className="absolute -right-24 bottom-10 h-80 w-80 rounded-full bg-purple-600/25 blur-3xl" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.20),transparent_34%),radial-gradient(circle_at_bottom,rgba(147,51,234,0.22),transparent_45%)]" />

      <section className="fade-up relative w-full max-w-[430px] overflow-hidden rounded-[34px] border border-white/70 bg-white/95 text-center shadow-[0_30px_90px_rgba(40,0,80,0.32)] ring-1 ring-pink-200/70">
        <div className="absolute inset-x-0 top-0 h-2 bg-gradient-to-r from-purple-500 via-purple-400 to-purple-300" />
        <div className="absolute -top-24 left-1/2 h-44 w-44 -translate-x-1/2 rounded-full bg-purple-200/55 blur-2xl" />
