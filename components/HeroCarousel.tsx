...
export default function HeroCarousel({ banners }: { banners: Banner[] }) {
  ...
  const renderCard = (banner: Banner) => {
    ...
    return (
      <div className="relative w-full aspect-[640/386] shrink-0 rounded-none border-b border-x-0 border-t-0 sm:border-2 sm:rounded-2xl border-pink-200 shadow-none sm:shadow-md sm:shadow-pink-200/40 overflow-hidden bg-pink-100">
  ...
  return (
    <div className="relative mx-auto max-w-5xl px-0 sm:px-6" style={{ overflow: "hidden" }}>
      <div
        className="flex"
        style={{
