...
export const metadata: Metadata = {
  title: "គោលការណ៍ឯកជនភាព — TheziessStore",
  description:
    "គោលការណ៍ឯកជនភាពរបស់ TheziessStore ពន្យល់ពីរបៀបប្រមូល ប្រើប្រាស់ និងការពារព័ត៌មានផ្ទាល់ខ្លួនរបស់អ្នក។",
};
...
const sections = [
  {
    ...
    content: (
      <p>
        TheziessStore (<a href="https://www.theziessstore.com" className="text-pink-600 hover:underline font-semibold">www.theziessstore.com</a>)
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">
          ការទូទាត់នៅ TheziessStore ដំណើរការតាម <strong className="text-pink-700">KHQR</strong>{" "}
  ...
  },
  {
    ...
    content: (
      <p>
        ដូច website ភាគច្រើន TheziessStore ប្រើប្រាស់ log files ស្វ័យប្រវត្តិ
    ...
    content: (
      <>
        ...
        <p className="text-sm text-pink-600">
          ...
          <a href="mailto:support@theziessstore.com" className="text-pink-700 font-semibold hover:underline">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">
          TheziessStore <strong className="text-pink-700">មិនមែនសម្រាប់</strong>
    ...
    content: (
      <>
        ...
        <div className="rounded-2xl border-2 border-pink-200 bg-gradient-to-br from-pink-50 to-white p-5 space-y-3">
          {[
            { icon: <Image src="/theziessstore-logo.png" alt="" width={20} height={20} className="h-5 w-5 object-contain" />, label: "TheziessStore" },
            { icon: <span aria-hidden="true">🌐</span>, label: <a href="https://www.theziessstore.com" className="text-pink-700 hover:underline font-medium">www.theziessstore.com</a> },
            { icon: <span aria-hidden="true">✉️</span>, label: <a href="mailto:support@theziessstore.com" className="text-pink-700 hover:underline font-medium">support@theziessstore.com</a> },
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="fade-up">
              ...
              <p className="mt-4 max-w-2xl text-sm font-semibold leading-8 text-pink-800/70 sm:text-base">
                ...
                ពេលប្រើប្រាស់សេវាកម្ម top-up របស់ TheziessStore។
              </p>
            ...
            <div className="fade-up rounded-[2rem] border border-white/80 bg-white/70 p-5 shadow-2xl shadow-pink-200/40 backdrop-blur-2xl sm:p-6" style={{ animationDelay: "120ms" }}>
              <div className="rounded-[1.6rem] border border-pink-100 bg-gradient-to-br from-white via-pink-50/80 to-white p-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xl font-black text-pink-950">TheziessStore</p>
