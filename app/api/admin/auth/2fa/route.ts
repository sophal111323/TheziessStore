...
async function handleWeb2FA(req: NextRequest, inputCode: string) {
  ...
  // 🛡️ Next factor: Generate 264-character Telegram security key
  ...
  // Send the 264-character key to Telegram Bot
  ...
  const res = NextResponse.json({
    ...
    requiresKey: true,
    email: payload.email,
    message: "កូដ 2FA ត្រឹមត្រូវ! Security Key 264 តួអក្សរត្រូវបានផ្ញើទៅកាន់ Telegram Bot របស់អ្នក។",
  });
