...
export const metadata: Metadata = {
  title: "Terms of Service | TheziessStore",
  description:
    "គោលការណ៍សេវាកម្ម ការសងប្រាក់ ការកែប្រែបញ្ជាទិញ និងការមិនទទួលខុសត្រូវក្រោយពេលទិញនៅ TheziessStore។",
  keywords: [
    "theziessstore",
    "terms of service",
    "privacy policy",
  ...
  openGraph: {
    title: "Terms of Service | TheziessStore",
    description:
      "អានលក្ខខណ្ឌសេវាកម្មរបស់ TheziessStore មុនពេលបញ្ជាទិញ ដើម្បីជៀសវាងការបញ្ចូល UID, Server ឬ Package ខុស។",
    type: "website",
  },
};
...
const termsSections = [
  {
    ...
    items: [
      ...
      "Account របស់អតិថិជនមានបញ្ហាដែលមិនពាក់ព័ន្ធនឹង TheziessStore",
      "Game provider ឬ third-party service មានការផ្លាស់ប្តូរ ឬពន្យារពេល",
    ],
  },
  {
    icon: "💳",
    title: "ការទូទាត់ និងការផ្ទៀងផ្ទាត់",
    tone: "soft",
    items: [
      "ការទូទាត់ត្រូវធ្វើឡើងតាម KHQR ឬវិធីដែល website ផ្តល់ជូន",
      "ត្រូវផ្ទៀងផ្ទាត់ឈ្មោះ និងចំនួនទឹកប្រាក់មុន Confirm",
      "រក្សាទុកវិក្កយបត្រ (Receipt / Screenshot) ទុកជាភស្តុតាង",
      "ប្រសិនបើមានបញ្ហាកាត់លុយតែមិនបានទំនិញ សូមទាក់ទង Support ភ្លាមៗ",
    ],
  },
  {
    icon: "📌",
    title: "ការទទួលខុសត្រូវរបស់អតិថិជន",
    tone: "soft",
    items: [
  ...
  },
  {
    ...
    tone: "soft",
    items: [
      "បញ្ហាកើតពីប្រព័ន្ធ TheziessStore ផ្ទាល់",
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
            <div className="terms-card rounded-[2.4rem] border border-white/80 bg-white/68 p-6 shadow-[0_28px_80px_rgba(236,72,153,0.14)] backdrop-blur-2xl sm:p-8 lg:p-10">
              ...
              <p className="mt-4 max-w-2xl text-base font-semibold leading-relaxed text-pink-950/65 sm:text-lg">
                សូមអានព័ត៌មាននេះមុនពេលបញ្ជាទិញ។ វាជួយឱ្យអ្នកយល់ពីការសងប្រាក់ ការកែប្រែ order និងទំនួលខុសត្រូវរបស់អ្នកពេលប្រើប្រាស់សេវា TheziessStore។
              </p>
            ...
            <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="bg-gradient-to-br from-pink-500 via-fuchsia-500 to-pink-500 p-6 text-white sm:p-8">
                ...
                <p className="mt-4 text-sm font-semibold leading-relaxed text-white/86">
                  ប្រសិនបើបញ្ហាកើតចេញពីប្រព័ន្ធ TheziessStore ឬការដឹកជញ្ជូនមិនបានបញ្ចប់ យើងនឹងពិនិត្យ និងដោះស្រាយដោយយុត្តិធម៌។
                </p>
              </div>
